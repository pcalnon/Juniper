...
ml#1869's 17 modified files and this handoff plus six `util/ad-hoc/` scripts that land with it.
...
The five `open_*` scripts exist because a worktree-isolated session's Bash classifier refuses a
