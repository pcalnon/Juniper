...
| PF-8 | — not a sequential suite | two **simultaneous** pinned-budget runs. **Run 2026-09-10** (`util/ad-hoc/2026-09-10_pf8_two_run_parallel_suite.yaml` via `2026-09-10_pf8_pair_driver.bash`): a second concurrent pinned run costs **+11.3%/step** (3 aligned pairs vs 6 controls, all at `step_count` 1770) — advisory. One run is 4.52 worker-eq unpinned / 2.15 pinned. Not checked in (fails the R-6 gate in CI; P2 4.2, now optional). `notes/JUNIPER_2026-09-10_JUNIPER-ECOSYSTEM_PERF-LANE-PF8-OCCUPANCY-PROBE.md` |
