# juniper-recurrence-client v0.3.0 Release Notes
...
`juniper-recurrence-client` v0.3.0 rolls up the release-worthy changes accumulated on `main` since the last published release, generated by the Juniper release-train from this package's CHANGELOG.
...
- **Release type:** MINOR
- **Primary focus:** new features, bug fixes, behavioural changes
- **Breaking changes:** NO
- **Package:** `juniper-recurrence-client` v0.3.0
